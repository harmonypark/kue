...
app.get('/jobs/search', provides('json'), json.search);
...
app.get('/jobs/types', provides('json'), json.types);
app.get('/jobs/:id', provides('json'), json.job);
app.get('/jobs/:id/output', provides('json'), json.output);
app.get('/jobs/:id/log', provides('json'), json.log);
app.put('/jobs/:id/state/:state', provides('json'), json.updateState);
app.put('/jobs/:id/priority/:priority', provides('json'), json.updatePriority);
app.del('/jobs/:id', provides('json'), json.remove);
app.post('/jobs', provides('json'), express.bodyParser(), json.createJob);
